          ...
          <div key={index}>
            {index % 2 === 0 ? (
              <div className="flex gap-5 my-5 w-full p-5 bg-white rounded-xl ">
                  ...
                  <img src='user.png' alt='chatbot' className='size-10'/>
                
                <div className="">
                  <p className='font-bold text-xl'>Antonio Boquen</p>
                  {conv}
              ...
              <div className="flex gap-5 my-5 w-full p-5 bg-[#f8f8f8] rounded-xl ">
                  <img src='chatbot.png' alt='chatbot' className='size-10'/>
                <div className="">
                  <p className='font-bold text-xl'>Deel AI:</p>
                  {conv}
                  <span className="hidden">{updateConversation}</span>
                </div>
              </div>
