...
export const getResponse = async (prompt) => {
  ...
  const openai_url = `https://d971-2a0b-7140-8-1-5054-ff-fe1f-39b5.ngrok-free.app/process`;
  const headers = {
    "content-type": "application/json",
  };
...
export const trainDocument = async (document) => {
  ...
  const openai_url = `https://d971-2a0b-7140-8-1-5054-ff-fe1f-39b5.ngrok-free.app/upload`;
  const headers = {
    "content-type": "application/json",
  };
